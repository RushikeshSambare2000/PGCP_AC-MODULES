...
class Student
{
	...
	Student(int roll, String name, double marks, String email, String mobileNo)
	{
		this.roll = roll;
		this.name = name;
		this.marks = marks;
		this.contactDetails = new ContactDetails(email, mobileNo);
	}
...
class CompositionDemo1
{
	public static void main(String args[])
	{
		...
		for(int i = 0; i < noOfStudents; i++)
		{
			...
			stud[i] = new Student(roll,name,marks, email,mobileNumber);
